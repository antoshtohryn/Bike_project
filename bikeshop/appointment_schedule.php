...
<div class="content">
    ...
    <form method="get" action="">
        ...
        <input type="search" id="search" class="search-input" name="search" placeholder="Enter surname or bike brand..." maxlength="30" value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
